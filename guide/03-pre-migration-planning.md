...
By now you should have [formally requested a data extract from the existing supplier](/prm-practice-migration/guide/get-started#request-data-extract) (source) of your Foundation Solution. Your existing supplier must provide your new supplier with this extract according to the Data Migration Standard (DMI02). 
